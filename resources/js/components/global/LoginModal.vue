...
<template>
    <div id="login-modal" v-show="show" v-on:click="show = false">
        <div class="login-box" v-on:click.stop="">
            ...
            <p class="learn-more-description">Roast 项目由 <a href="https://xueyuanjun.com" target="_blank">Laravel 学院</a>提供，Laravel 学院致力于提供优质 Laravel 中文学习资源。</p>

            <a class="learn-more-button" href="https://xueyuanjun.com/api-driven-development-laravel-vue" target="_blank">关于本项目的构建教程，可以在这里看到</a>
        </div>
    </div>
</template>
